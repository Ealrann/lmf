...
import org.logoce.lmf.core.notification.observatory.*;
import org.logoce.lmf.core.notification.observatory.internal.eobject.poi.*;
...
import org.logoce.lmf.core.notification.observatory.internal.notifier.NotifierAdapterObservatory;
import org.logoce.lmf.core.notification.observatory.internal.notifier.NotifierObservatory;
...
public abstract class AbstractRootObservatory implements IObservatory
{
	...
	public static abstract class Builder implements IObservatoryBuilder, InternalObservatoryBuilder
	{
		...
		@Override
		public <T extends LMObject> IEObjectObservatoryBuilder<T> explore(final int referenceId,
																		  final Class<T> cast)
		{
