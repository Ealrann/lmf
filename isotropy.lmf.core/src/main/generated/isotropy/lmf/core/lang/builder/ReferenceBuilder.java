...
public final class ReferenceBuilder<T extends LMObject> implements Builder<T>
{
	...
	private static final RelationLazyInserter<ReferenceBuilder<?>> RELATION_INSERTER = new RelationLazyInserter.Builder<ReferenceBuilder<?>>().add(
			Reference.Features.group,
			ReferenceBuilder::_group).add(Reference.Features.parameters, ReferenceBuilder::addParameter).build();
