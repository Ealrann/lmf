...
{
	private static final FeatureGetter<Group<?>> GET_MAP = new FeatureGetter.Builder<Group<?>>().add(Features.name,
																									 Group::name)
																								.add(Features.concrete,
																									 Group::concrete)
																								.add(Features.includes,
																									 Group::includes)
																								.add(Features.features,
																									 Group::features)
																								.add(Features.generics,
																									 Group::generics)
																								.build();
