...
public final class LMCorePackage implements IModelPackage
{
	...
	public static final List<GroupDescriptor<?>> groups = List.of(new GroupDescriptor<>(LMOBJECT_GROUP, null),
																  ...
																  new GroupDescriptor<>(ATTRIBUTE_GROUP,
																						AttributeBuilder::new),
																  new GroupDescriptor<>(RELATION_GROUP,
																						RelationBuilder::new),
																  ...
																  new GroupDescriptor<>(GENERIC_GROUP,
																						GenericBuilder::new));
