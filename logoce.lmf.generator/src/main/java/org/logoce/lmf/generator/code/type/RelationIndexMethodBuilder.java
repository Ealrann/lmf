...
public final class RelationIndexMethodBuilder implements CodeBuilder<List<FeatureResolution>, MethodSpec>
{
	private final Group<?> group;

	public RelationIndexMethodBuilder(final Group<?> group)
	{
		this.group = group;
	}
	...
	public MethodSpec build(final List<FeatureResolution> featureResolutions)
	{
		...
		else
		{
			...
			int index = 0;
			for (final var feature : relations)
			{
