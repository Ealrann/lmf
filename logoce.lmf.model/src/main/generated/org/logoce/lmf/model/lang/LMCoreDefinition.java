...
public interface LMCoreDefinition {
  interface Features {
    ...
    interface META_MODEL {
      ...
      Attribute<Boolean, Boolean> GEN_NAME_PACKAGE = new AttributeBuilder<Boolean, Boolean>().name("genNamePackage").immutable(true).many(false).mandatory(false).rawFeature(MetaModel.Features.genNamePackage).datatype(() -> Units.BOOLEAN).defaultValue(null).build();
      Attribute<String, String> EXTRA_PACKAGE = new AttributeBuilder<String, String>().name("extraPackage").immutable(true).many(false).mandatory(false).rawFeature(MetaModel.Features.extraPackage).datatype(() -> Units.STRING).defaultValue(null).build();
  ...
  interface Groups {
    ...
    Group<MetaModel> META_MODEL = new GroupBuilder<MetaModel>().name("MetaModel").concrete(true).addInclude(() -> new IncludeBuilder<Model>().group(() -> MODEL).build()).addFeature(() -> Features.META_MODEL.ALL.get(0)).addFeature(() -> Features.META_MODEL.ALL.get(1)).addFeature(() -> Features.META_MODEL.ALL.get(2)).addFeature(() -> Features.META_MODEL.ALL.get(3)).addFeature(() -> Features.META_MODEL.ALL.get(4)).addFeature(() -> Features.META_MODEL.ALL.get(5)).addFeature(() -> Features.META_MODEL.ALL.get(6)).addFeature(() -> Features.META_MODEL.ALL.get(7)).addFeature(() -> Features.META_MODEL.ALL.get(8)).addFeature(() -> Features.META_MODEL.ALL.get(9)).addFeature(() -> Features.META_MODEL.ALL.get(10)).lmBuilder(new BuilderSupplier<>(MetaModelBuilder::new)).build();
