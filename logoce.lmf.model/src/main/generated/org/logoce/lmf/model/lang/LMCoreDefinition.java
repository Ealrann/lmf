...
public interface LMCoreDefinition {
  ...
  interface Groups {
    ...
    Group<Feature<?, ?>> FEATURE = new GroupBuilder<Feature<?, ?>>().name("Feature").concrete(false).addInclude(() -> new IncludeBuilder<Named>().group(() -> NAMED).build()).addFeature(() -> Features.FEATURE.ALL.get(0)).addFeature(() -> Features.FEATURE.ALL.get(1)).addFeature(() -> Features.FEATURE.ALL.get(2)).addFeature(() -> Features.FEATURE.ALL.get(3)).addFeature(() -> Features.FEATURE.ALL.get(4)).addGeneric(() -> Generics.FEATURE.get(0)).addGeneric(() -> Generics.FEATURE.get(1)).build();
