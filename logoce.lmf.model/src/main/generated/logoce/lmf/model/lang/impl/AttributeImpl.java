...
import logoce.lmf.model.lang.Datatype;
...
public final class AttributeImpl<UnaryType, EffectiveType> extends FeaturedObject implements Attribute<UnaryType, EffectiveType> {
  private static final FeatureGetter<Attribute<?, ?>> GET_MAP = new FeatureGetter.Builder<Attribute<?, ?>>().add(logoce.lmf.model.lang.Attribute.Features.name, logoce.lmf.model.lang.Attribute::name).add(logoce.lmf.model.lang.Attribute.Features.immutable, logoce.lmf.model.lang.Attribute::immutable).add(logoce.lmf.model.lang.Attribute.Features.many, logoce.lmf.model.lang.Attribute::many).add(logoce.lmf.model.lang.Attribute.Features.mandatory, logoce.lmf.model.lang.Attribute::mandatory).add(logoce.lmf.model.lang.Attribute.Features.rawFeature, logoce.lmf.model.lang.Attribute::rawFeature).add(logoce.lmf.model.lang.Attribute.Features.datatype, logoce.lmf.model.lang.Attribute::datatype).add(logoce.lmf.model.lang.Attribute.Features.defaultValue, logoce.lmf.model.lang.Attribute::defaultValue).add(logoce.lmf.model.lang.Attribute.Features.parameters, logoce.lmf.model.lang.Attribute::parameters).build();
