...
import logoce.lmf.model.lang.impl.AttributeImpl;
import logoce.lmf.model.lang.impl.EnumImpl;
import logoce.lmf.model.lang.impl.GenericImpl;
import logoce.lmf.model.lang.impl.GroupImpl;
...
import logoce.lmf.model.lang.impl.UnitImpl;
...
public interface LMCoreDefinition {
  ...
  interface JavaWrappers {
    JavaWrapper<RawFeature<?, ?>> RAW_FEATURE = new JavaWrapperImpl<>("RawFeature", "logoce.lmf.model.api.feature");

    JavaWrapper<IModelPackage> I_MODEL_PACKAGE = new JavaWrapperImpl<>("IModelPackage", "logoce.lmf.model.api.model");
