...
public final class JavaWrapperImpl<T> extends FeaturedObject implements JavaWrapper<T> {
  private static final FeatureGetter<JavaWrapper<?>> GET_MAP = new FeatureGetter.Builder<JavaWrapper<?>>().add(logoce.lmf.model.lang.JavaWrapper.Features.name, logoce.lmf.model.lang.JavaWrapper::name).add(logoce.lmf.model.lang.JavaWrapper.Features.domain, logoce.lmf.model.lang.JavaWrapper::domain).build();
